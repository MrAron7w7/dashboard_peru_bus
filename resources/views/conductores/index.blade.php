...
@section('content')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex items-center space-x-3">
            ...
            <div>
                <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Administración de Conductores</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400">Gestiona todos los conductores del sistema de transporte
                </p>
            </div>
        </div>
